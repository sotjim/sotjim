...
> Άνοιγμα αυτής της σελίδας στο [https://sotjim.github.io/sotjim/](https://sotjim.github.io/sotjim/)
...
* αναζήτηση για **https://github.com/sotjim/sotjim** και εισαγωγή

## Επεξεργασία αυτού του έργου ![Σήμα κατάστασης κατασκευής](https://github.com/sotjim/sotjim/workflows/MakeCode/badge.svg)

Για επεξεργασία αυτού του αποθετηρίου στο MakeCode.

* άνοιγμα [https://makecode.microbit.org/](https://makecode.microbit.org/)
* κάντε κλικ στην **Εισαγωγή** και έπειτα στην **Εισαγωγή διεύθυνσης URL**
* επικολλήστε **https://github.com/sotjim/sotjim** και κάντε κλικ στην εισαγωγή
...
![Προβολή απόδοσης των μπλοκ](https://github.com/sotjim/sotjim/raw/master/.github/makecode/blocks.png)
